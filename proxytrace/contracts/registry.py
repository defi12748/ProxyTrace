...
DEFAULT_TOOL_DESCRIPTORS: dict[str, dict[str, Any]] = {
    ...
    "escalate_ticket": {
        ...
        "input_example": {
            ...
            "board": "SCRUM",
            "priority": "High",
            "reason": "Production authentication is unavailable.",
        },
        "output_example": {
            "updated": True,
            "issue_key": "SCRUM-1",
    ...
    "jira_get_issue": {
        ...
        "requires_approval": False,
        "replay_policy": "mock_from_recording",
        "trust_level": "transparent_intercept",
        "input_example": {"issue_key": "SCRUM-1"},
        "output_example": {
            "key": "SCRUM-1",
            ...
            "status": "To Do",
            "issue_type": "Incident",
            "url": "https://proxytrace.atlassian.net/browse/SCRUM-1",
        },
    },
    "jira_add_comment": {
        "version": "v1",
        ...
        "replay_policy": "mock_only",
        "trust_level": "transparent_intercept",
        "input_example": {"issue_key": "SCRUM-1", "text": "Triage complete."},
        "output_example": {"id": "10000"},
    },
    "jira_set_priority": {
        "version": "v1",
        "tool_type": "destructive",
        ...
        "replay_policy": "mock_only",
        "trust_level": "transparent_intercept",
        "input_example": {"issue_key": "SCRUM-1", "priority": "High"},
        "output_example": {
            "updated": True,
            "issue_key": "SCRUM-1",
            "project_key": "SCRUM",
            "priority": "High",
            "reason": "Transparent Jira priority update.",
            "status": "jira_priority_updated",
            "source": "jira_cloud",
        },
    },
